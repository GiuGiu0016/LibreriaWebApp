...
List<Affitto> listalibri = new ArrayList<>(gest.mappaLibriAcquistati().values());
%>
	<!-- titolo principale -->
	<div class="header" >
	...
	<div class="topnav">
		<h3 style="text-align: center;color: white;">Lista Libri Acquistati</h3>
	</div>
	    ...
	    <div class="card" >
			...
			<tr>
				...
				<td><%=affitto.getQuantita()*libro.getCosto()%>&#x20AC</td>
