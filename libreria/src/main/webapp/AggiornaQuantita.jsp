...
%>
	...
	<!-- Sotto pagina -->
	   <div class="card" >
	      <h1><%=messaggio%></h1>
	      <h3><%=messaggio2%></h3>
	        <form action="quantita?user=<%=user%>" method="post">
...
%>
	...
	<!-- Sotto pagina sinistra n2 -->
	    <div class="card" >
	    <form action="modificaQuantita?user=<%=user%>" method="post" style=" font-size: 105%;text-align:center;">
	     <label id="id" style="margin-top: 2%;" >Inserisci id-Libro:</label>
			...
			<%for(Libro libro : listalibri){%>
		     ...
		     <label id="quantita">Inserisci quantita:</label>
			<input name="quantita" id="quantita" type="number" placeholder="quantita"><br>
