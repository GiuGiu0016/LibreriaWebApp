...
%>
	...
	<!-- Sotto pagina sinistra n2 -->
	    <div class="card" >
	    <form action="AffittoLibro?user=<%=user%>" method="post" style=" font-size: 105%;text-align:center;">
		...
		<input type="submit"  value="Affitta===>" style="margin-top: 1%;font-size: 105%;margin-left: 20%;" >
	      </form>
